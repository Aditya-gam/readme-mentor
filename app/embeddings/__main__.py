...
This module provides a command-line interface for ingesting repositories
...
Examples:
  ...
  python -m app.embeddings.ingest https://github.com/user/repo --chunk-size 512
  python -m app.embeddings.ingest https://github.com/user/repo --file-glob "*.md" "docs/**/*.md"
  python -m app.embeddings.ingest https://github.com/user/repo --persist-dir ./data/chroma
        """,
    )
