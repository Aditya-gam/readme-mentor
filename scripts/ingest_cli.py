#!/usr/bin/env python3
"""CLI script for ingesting repositories into the vector store.

This script provides a command-line interface for ingesting GitHub repositories
into the vector store for readme-mentor.
"""
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python scripts/ingest_cli.py https://github.com/octocat/Hello-World
  python scripts/ingest_cli.py https://github.com/user/repo --chunk-size 512
  python scripts/ingest_cli.py https://github.com/user/repo --file-glob "*.md" "docs/**/*.md"
  python scripts/ingest_cli.py https://github.com/user/repo --persist-dir ./data/chroma
        """,
    )
