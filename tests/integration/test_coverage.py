"""Comprehensive coverage tests for the ingestion pipeline.

This module tests all functions in the ingestion pipeline with proper mocking
to achieve high test coverage without external dependency issues.
"""
